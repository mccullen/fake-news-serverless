...
# Importing the Excel Having the Claim Links List
 ...
 Excel_File_Claimed = pd.read_excel('api/Copy of Fake News List and Claim.xlsx','ClaimLinks')
 Excel_File_Fake1   = pd.read_excel('api/Copy of Fake News List and Claim.xlsx','FakeNewsList1')
 Excel_File_Fake2   = pd.read_excel('api/Copy of Fake News List and Claim.xlsx','FakeNewsList2')
