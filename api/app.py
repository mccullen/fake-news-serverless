...
import csv
import api.InputFileAnalyzer as m
...
class handler(SimpleHTTPRequestHandler):
    ...
    def __persist(self):
        ...
        with open('api/Fake-news-original.csv', mode='a', newline="") as input_file:
            print("writing to fake-news-original.csv")
            input_writer = csv.writer(input_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
            input_writer.writerow(row)
        with open('api/Fake-news-original-with-nonEnglish.csv', mode='a', newline="") as input_file:
            print("writing to non-english")
            input_writer = csv.writer(input_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
            input_writer.writerow(row)
